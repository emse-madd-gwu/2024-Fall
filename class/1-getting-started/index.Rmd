...
## `r fa('globe')` Course website: https://madd.seas.gwu.edu/2023-Fall/

--

## `r fa('slack')` Course slack: https://emse-madd-f23.slack.com

--

## `r fa('r-project')` & RStudio: [Course Software Page](https://madd.seas.gwu.edu/2023-Fall/software.html)
...
### Take [this self assessment](https://madd.seas.gwu.edu/2023-Fall/self-assessment.html)
...
# [Semester Project](https://madd.seas.gwu.edu/2023-Fall/project/0-overview.html) (45% of grade)
...
<center>
<img src="https://madd.seas.gwu.edu/2023-Fall/figs/grade-breakdown-1.png" width=90%>
</center>
...
## `r fa('slack')` Use [Slack](https://emse-madd-f23.slack.com/) to ask questions.
...
# [View project Ideas](https://docs.google.com/presentation/d/1bNnsKWkU8FwGHIL_jK72ilXsvhZhr98Q/edit?usp=sharing)
...
1. If you haven't already, install everything on the [software page](https://madd.seas.gwu.edu/2023-Fall/software.html)
...
## If you haven't yet, install [these packages](https://raw.githubusercontent.com/emse-madd-gwu/2023-Fall/main/content/packages.R)
