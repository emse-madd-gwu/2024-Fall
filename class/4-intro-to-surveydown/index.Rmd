...
- Connect to your database for storing data.
...
This happens with `sd_database()`.

Ignore this for now - we'll connect our database soon!

For now you can see the data from chosen responses in a `data.csv` file written in the project folder.
...
- Insert the content in your `practiceSurvey.qmd` file into your Google Sheet.
