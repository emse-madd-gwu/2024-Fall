...
- Review the slide design guidelines discussed in [class](https://madd.seas.gwu.edu/2024-Fall/class/14-communicating-results.html) as a check list when designing your slides.
